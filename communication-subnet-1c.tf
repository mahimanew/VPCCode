...
resource "aws_route_table" "StudentPlacement-Frankfurt-communication-subnet-1c-router" {
  vpc_id = aws_vpc.StudentPlacement-Frankfurt-vpc.id
  ...
  route {
   ...
   tags = {
   Name = "StudentPlacement-Frankfurt-communication-subnet-1c-router"
  }
}
...
resource "aws_route_table_association" "StudentPlacement-Frankfurt-communication-subnet-1c-association" {
  ...
  route_table_id = aws_route_table.StudentPlacement-Frankfurt-communication-subnet-1c-router.id
}